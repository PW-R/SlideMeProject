    ...
    <div>
      ...
      <div className="m-6">
          ...
          <Link to="/OrderInfoInputPage" className='w-[300px] h-[50px] '>
            <div className='rounded-md bg-[#2CD64B] text-l w-full h-full text-white text-l flex items-center justify-center hover:bg-[#43af56] transition mt-4 py-2'>
          ...
          <div className="grid grid-cols-3 gap-4 mt-8">
            <Link to='#' className="relative w-fit">
              ...
              <div className="w-[100px] h-[36px] text-[13px] text-black bg-[#66DC82] rounded-md px-2 py-1 border-none overflow-hidden whitespace-nowrap text-ellipsis flex items-center justify-start relative z-10 cursor-pointer text-left">
                Homecar-อู่รถมั่นคง
              </div>
            </Link>
            <Link to='#' className="relative w-fit">
            ...
            {/* ปุ่ม + สร้างตำแหน่ง*/}
            <Link to='#' className="relative w-fit">
              <div className='w-[100px] h-[36px] text-[11px] text-black bg-[#66DC82] rounded-[5px] px-2 py-1 border-none overflow-hidden whitespace-nowrap text-ellipsis flex items-center justify-center cursor-pointer'>
            ...
            <Link to='/ShopReccommend'>
              <Carousel className='rounded-xl '>
                  <Carousel.Item interval={1000}>
                      <img className="d-block w-100 rounded-xl" src="./advert_car1.svg" alt="First slide"/>
                  </Carousel.Item>
                  <Carousel.Item interval={1000}>
                      <img className="d-block w-100 rounded-xl" src="./advert_car2.svg" alt="Second slide"/>
                  </Carousel.Item>
                  <Carousel.Item interval={1000}>
